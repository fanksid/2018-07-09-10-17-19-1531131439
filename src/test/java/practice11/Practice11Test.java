...
public class Practice11Test {
    ...
    public void should_teacher_have_name_and_age_and_classes() {
        LinkedList<practice11.Klass> linkedList = new LinkedList<>();
    ...
    @Test
    public void should_teacher_be_notified_when_student_join_any_classes_it_teaches() {
        LinkedList<practice11.Klass> linkedList = new LinkedList<>();
        linkedList.add(klass2);
        Teacher tom = new Teacher(1, "Tom", 21, linkedList);
        Student jerry = new Student(1, "Jerry", 8, new Klass(3));
    ...
    @Test
    public void should_teacher_be_notified_when_any_class_it_teaches_assigned_a_leader() {
        LinkedList<practice11.Klass> linkedList = new LinkedList<>();
        linkedList.add(klass2);
        Teacher tom = new Teacher(1, "Tom", 21, linkedList);
        Student jerry = new Student(1, "Jerry", 8, new Klass(3));
